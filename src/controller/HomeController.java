...
public class HomeController implements Initializable {
    ...
    public void imageDisplay(ImageView imgView,TableView<Produit> table,String imageUrl) {
        ...
        File file = new File("D:\\imgeftp\\"+produitUtil.returnImage(table.getSelectionModel().getSelectedItem().getId(),imageUrl));
        String img;               
        try {
        ...
        btnDetails.setOnAction(e -> {
            if (table.getSelectionModel().getSelectedItem() != null) {
                ...
                TrayNotification tray = 
                    new TrayNotification("Error", "Select a product", NotificationType.ERROR);
